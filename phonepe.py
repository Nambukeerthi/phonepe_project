...
def user_type(df_csv):
        ...
        fig_bar_1 = px.bar(aguyg_test, x = "Brands", y = "Transaction_count", title = f"{year} BRANDS NAME AND TRANSACTION COUNT",color_discrete_sequence= px.colors.sequential.haline)
